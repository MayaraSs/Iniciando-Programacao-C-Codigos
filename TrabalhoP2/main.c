...
int main()
{
    ...
    srand(time(NULL));/**para criar sequencia diferenciada quando executado o programa
                     para que não precise introduzir nova semente retorna o valor do tempo do computador em segundos*/
...
void Cliente_Cadastro()
{
    ...
    else /** se abrir corretamente*/
    {
        fwrite(&ctemp, sizeof(cliente), 1, cadastroCliente);/***/
        fclose(cadastroCliente);/**fecha arquivo */
    }
}
